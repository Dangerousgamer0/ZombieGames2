...
var zombieImg,bg,boy,skullImg,handIgm,deadImg,bg2,coinImg;
...
function preload(){
      ...
      zombieImage=loadAnimation("images/zombie1.png","images/zombie2.png","images/zombie3.png","images/zombie4.png","images/zombie5.png","images/zombie6.png");
      ...
      restarting = loadImage("images/restore.png");
...
function spawnHands(){
  if(frameCount % 120 === 0){
     var hand = createSprite(860,450,10,40);
     hand.addImage("hand",handImg);
     hand.scale = 0.14;
     hand.velocityY = -(4 + score / 50);
     hand.lifetime = 200;
     handGroup.add(hand);
